...
const ReOpdFamilyHistory = () => {
     ...
     useEffect(() => {
          const backAction = () => {
               navigation.replace('ReOpdPastHistory');
               return true;
          };
               ...
               <View style={styles.container}>
                    ...
                    <View style={styles.submitbutton}>
                         <Button
                              mode="contained"
                              style={styles.btn}
                              onPress={() => navigation.replace('ReOpdPastHistory')}>
                              Previous
                         </Button>
                         <Button
                              mode="contained"
                         ...
                         <Button
                              mode="contained"
                              style={styles.btn}
                              onPress={() => navigation.navigate('ReOpdMedicineHistory')}>
                              Next / Skip
                         </Button>
                    </View>
...
export default ReOpdFamilyHistory;
