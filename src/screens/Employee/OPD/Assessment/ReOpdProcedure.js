...
const ReOpdProcedure = () => {
     ...
     useEffect(() => {
          const backAction = () => {
               navigation.replace('ReOpdTreatment');
               return true;
          };
     ...
     const submitTreatmenthandler = async () => {
          const _body = {
               ...
               opdprocedurehistoryarray: [...temp, ...opdAssessmentforEdit],
          };
          try {
               await axios
          ...
          <>
               ...
               <View style={styles.container}>
                    ...
                    <View style={styles.submitbutton}>
                         ...
                         <Button
                              mode="contained"
                              onPress={() => navigation.navigate('ReOpdAdvice')}>
                              Next / Skip
                         </Button>
                    </View>
