...
const ReOpdPersonalHistory = () => {
     ...
     useEffect(() => {
          const backAction = () => {
               navigation.navigate('ReOpdMedicineHistory');
               return true;
          };
     ...
     const FetchMobileOpdAssessmentForEdit = async () => {
          try {
               await axios
                    ...
                    .then(res => {
                         setOpdAssessmentforEdit(res.data.opdpersonalhistoryarray);
                    });
          } catch (error) {
               console.error(error);
          }
               ...
               <ScrollView style={styles.container}>
                    ...
                    <View style={styles.submitbutton}>
                         <Button
                              mode="contained"
                              style={styles.btn}
                              onPress={() => navigation.replace('ReOpdMedicineHistory')}>
                              Previous
                         </Button>
                         <Button
                              mode="contained"
...
export default ReOpdPersonalHistory;
