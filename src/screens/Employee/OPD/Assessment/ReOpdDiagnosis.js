     ...
     const FetchMobileOpdAssessmentforEdit = async () => {
          try {
               await axios
                    ...
                    .then(res => {
                         setOpdAssessmentforEdit(res.data.opddiagnosishistoryarray);
                    });
          } catch (error) {
               console.error(error);
          }
          ...
          <>
               ...
               <ScrollView vertical style={styles.container}>
                              ...
                              <View style={{ height: 'auto' }}>
                                   ...
                                   <ScrollView
                                        ...
                                        <Table borderStyle={{ borderWidth: 1, borderColor: 'gray' }}>
                                             <Rows
                                                  // data={tableData}
                                                  data={opdAssessmentforEdit?.map((row, index) => [
                                                       index + 1,
                                                       row.icdcode,
                                                       row.illnessname,
                                                       row.diagnosis_type,
                    ...
                    <View style={styles.submitbutton}>
                         <Button
                              mode="contained"
                              onPress={() => navigation.replace('ReOpdGeneralExamination')}>
                              Previous
                         </Button>
