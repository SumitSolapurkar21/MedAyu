...
const ReOpdAdvice = () => {
     ...
     const [advice, setAdvice] = useState(opdAssessmentforEdit.opdtemplate);
     const [selectedAdviceLabel, setSelectedAdviceLabel] = useState(opdAssessmentforEdit.opdtemplate);
     ...
     useEffect(() => {
          const backAction = () => {
               navigation.replace('ReOpdProcedure');
               return true;
          };
          ...
          try {
               await axios
                    ...
                    .then(res => {
                         ...
                         setSelectedAdvice(opdTemplateData.opdtemplate_text);
                         setSelectedAdviceLabel(opdTemplateData.opdtemplate);
                    });
          } catch (error) {
               console.error(error);
          }
          ...
          <>
               ...
               <ScrollView style={styles.container}>
                    ...
                    <View style={styles.submitbutton}>
                         <Button
                              mode="contained"
                              onPress={() => navigation.replace('ReOpdProcedure')}>
                              Previous
                         </Button>
