...
const ReOpdFollowup = () => {
     ...
     useEffect(() => {
          ...
          FetchMobileOpdAssessmentfromEdit();
     ...
     // List of FetchMobileOpdAssessmentfromEdit....
     const FetchMobileOpdAssessmentfromEdit = async () => {
          try {
               await axios
                    ...
                    .then(res => {
                         if (res.data.data && res.data.data?.length > 0) {
                              ...
                              setSubmittedFormData({
                                   ...
                                   followup_days: fetchedData.followup_days,
                                   followup_day: fetchedData.followup_day,
                              });
                         }
                    });
          } catch (error) {
